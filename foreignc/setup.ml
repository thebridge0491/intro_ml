...
(* OASIS_START *)
(* DO NOT EDIT (digest: 48e2378087ee24526164ad9914e24f98) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_dlllib =
                        [(OASISExpr.EBool true, ["libintro_c-practice.so"])];
                   ...
                   {
                      lib_modules = ["Foreignc"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "foreignc";
                      lib_findlib_directory = Some "foreignc";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "intro_ml.foreignc"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_digest = Some "c\244\228k\014\007)\223s\159L.\194\252\003'";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
