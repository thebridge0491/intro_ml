(* OASIS_START *)
(* DO NOT EDIT (digest: 84979f3b0bc648f74ad026ad23ecc1d5) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("intro_ml.foreignc", ["src/intro_ml"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_intro_ml_foreignc_ccopt"; "compile"],
            [
          ...
          (["oasis_library_intro_ml_foreignc_cclib"; "link"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_intro_ml_foreignc_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_intro_ml_foreignc_dlllib"; "link"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-dllib"; P "libintro_c-practice.so"])
            ]);
          (["oasis_library_intro_ml_foreignc_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          ([
              "oasis_library_intro_ml_foreignc_native";
              "ocaml";
              "link";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          ([
              "oasis_library_intro_ml_foreignc_byte";
              "ocaml";
              "ocamldep";
              "byte"
           ],
          ...
          ([
            ...
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_executable_ts_main_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_executable_ts_main_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_executable_ts_main_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_executable_ts_main_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_executable_ts_main_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_executable_ts_main_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])])
       ];
     includes = [("tests", ["src/intro_ml"])]
  }
  ;;
