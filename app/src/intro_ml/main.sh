#!/bin/sh
# (*
BOLT_CONFIG=resources/bolt_new.conf BISECT_FILE=_build/bisect_main exec ocaml -w +a-4 -safe-string -strict-sequence -short-paths -strict-formats -I `ocamlfind query bisect` -I `ocamlfind query volt` -I src -I _build/src/intro_ml $0 $@
exit
*) use "topfind" ;;
(* #!/usr/bin/env ocaml *)
