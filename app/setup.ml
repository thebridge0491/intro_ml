...
(* OASIS_START *)
(* DO NOT EDIT (digest: c7be77d9e7d1d652a32bb4cc33bc5d83) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("intro_ml.util", None);
                           FindlibPackage ("intro_ml.practice", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_digest = Some "\233,\021l\201t\1574P\024\153{\245\195\168\253";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
