(* OASIS_START *)
(* DO NOT EDIT (digest: bf5f9901135db2caf08f761d33b04306) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("intro_ml.practice", ["src/intro_ml"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_intro_ml_practice_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          ([
              "oasis_library_intro_ml_practice_native";
              "ocaml";
              "link";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          ([
              "oasis_library_intro_ml_practice_byte";
              "ocaml";
              "ocamldep";
              "byte"
           ],
