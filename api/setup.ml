...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1a75d8da7a79a6807a34200b066c5fa2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          beta_features = ["findlib_directory"];
            ...
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://bitbucket.org/thebridge0491/intro_ml.git";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build with tests";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Generate coverage data.";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "intro_ml.practice";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("bisect", None);
                           FindlibPackage ("batteries", None);
                           FindlibPackage ("intro_ml.util", None)
                        ];
                      ...
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-thread"; "-w"; "+a-4"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-thread"; "-w"; "+a-4"])]
                   },
                   {
                      lib_modules = ["Practice"];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Practice_Classic";
                           "Practice_Sequenceops";
                           "Practice_Classic_Puzzles";
                           "Practice_Classic_Hiorder";
                           "Practice_Sequenceops_Hiorder";
                           "Practice_Classic_Streams"
                        ];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "practice";
                      lib_findlib_directory = Some "practice";
                      lib_findlib_containers = ["intro_ml"]
                   });
               Doc
                 ({
                     cs_name = "intro_ml.practice";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "build_test", true)
                        ];
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("bisect", None);
                           FindlibPackage ("intro_ml.util", None);
                           InternalLibrary "intro_ml.practice"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "ts_main.ml"});
               Test
                 ({
                     cs_name = "ts_main";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest = Some "\129\182\n\150Gf7\012\232\002\209dfi\217\176";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
