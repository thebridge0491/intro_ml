(* OASIS_START *)
(* DO NOT EDIT (digest: 4a7b64a77c50519416a82391794a5173) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("intro_ml.util", ["src/intro_ml"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_intro_ml_util_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_library_intro_ml_util_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_library_intro_ml_util_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          ([
              "oasis_library_intro_ml_util_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          (["oasis_library_intro_ml_util_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-thread"; A "-w"; A "+a-4"])]);
          ([
              "oasis_library_intro_ml_util_native";
              "ocaml";
