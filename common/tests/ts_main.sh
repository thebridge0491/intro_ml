#!/bin/sh
# (*
BOLT_CONFIG=resources/bolt_new.conf BISECT_FILE=_build/bisect_test exec ocaml -w +a-4 -safe-string -strict-sequence -short-paths -strict-formats -I `ocamlfind query bisect` -I `ocamlfind query volt` -I src -I tests -I _build/src/swig -I _build/src/intro_ml $0 $@
*) use "topfind" ;;
(* #!/usr/bin/env ocaml *)
...
(* #mod_use "intro_ml/util.ml" ;; *)
(* #load "intro_ml-util.cma" ;; *)
