...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0f0bbf72805b8912dea207d694253672) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "util";
                      lib_findlib_directory = Some "util";
     ...
     oasis_digest = Some "\214NQ\253$\002\021\179$\223?\235\148\238\005\247";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
